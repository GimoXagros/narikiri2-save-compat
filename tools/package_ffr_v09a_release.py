...
from apply_ffr_v09a import NAME, PATCH, SOURCE, TARGET
...
TEXT = {
    **{f'docs/history/v0.9/{n}': f'docs/history/v0.9/{n}' for n in ('README.md','BUILDING.md','VERIFICATION.md','RELEASE_NOTES.md','RELEASE_POLICY.md')},
    'apply_ffr_v09a.py': 'tools/apply_ffr_v09a.py',
    'bps.py': 'tools/bps.py',
    'README.md': 'README.md',
    'LICENSE': 'LICENSE',
    'RIGHTS.md': 'RIGHTS.md',
    ...
    'verification/v0.9a.json': 'verification/v0.9a.json',
}
...
def main():
    ...
    if any(gate[k] != manifest[k] for k in ('target_sha256','patch_sha256','review_ledger_sha256')):
    ...
    archive = a.output_dir/(NAME+'_FFR_PACKAGE.zip')
